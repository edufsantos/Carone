...
--
-- Host: 127.0.0.1
-- Generation Time: 09-Ago-2019 às 23:34
...
(4, 'R9n3_aMpobM', 'Olá! Seja bem vindo ao Science Talk, hoje falaremos sobre IF MAKER juntamente também sobre Tecnologia no Brasil. Prepara um lanche, coisa leve pra não engordar e vem com a gente!', 'IF Maker', '2019-03-05', '0a53404a146940a581e2df9b87203552-1565383570.png');
...
--
ALTER TABLE `podcast_convidado`
  MODIFY `id_podcast_conv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `podcast_tema`
--
ALTER TABLE `podcast_tema`
  MODIFY `id_podcast_tema` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
